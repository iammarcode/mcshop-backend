...
CREATE TABLE IF NOT EXISTS `product_category` (
    ...
    `description` TEXT NULL COMMENT 'Product category description',
...
CREATE TABLE IF NOT EXISTS `product_discount` (
    ...
    `description` TEXT NULL COMMENT 'Discount description',
    `type` VARCHAR(100) NOT NULL COMMENT 'Discount type',
    `value` DECIMAL(10,2) NOT NULL COMMENT 'Discount value',
    `active` BOOLEAN NOT NULL DEFAULT TRUE COMMENT 'Is active',
...
CREATE TABLE IF NOT EXISTS `shopping_cart_item` (
    ...
    `product_id` CHAR(36) NOT NULL COMMENT 'Product id',
    `shopping_cart_id` CHAR(36) NOT NULL COMMENT 'Shopping cart id',
    `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
    `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Last update time',
    `deleted_at` DATETIME NULL COMMENT 'Soft delete timestamp'
